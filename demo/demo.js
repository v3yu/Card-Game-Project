...
const deck = new Deck([new CrashOut(),new CrashOut(),new CrashOut(),new CrashOut(),new CrashOut(), new SpaghettiCodeShield,new SpaghettiCodeShield,new SpaghettiCodeShield,new SpaghettiCodeShield, new TripToStudentHealth()]);
