...
describe('Player class', () => {
    ...
    test('takeDamage with block overflow deals correct damage', () => {
        ...
        player.takeDamage(15);
        expect(player.block).toBe(0);
        expect(player.currentHealth).toBe(95);
    });
    ...
    test('resetEnergy resets energy to maxEnergy', () => {
        ...
        player.resetEnergy();
        expect(player.currentEnergy).toBe(player.maxEnergy);
    });
